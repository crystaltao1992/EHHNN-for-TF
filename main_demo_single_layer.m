...
% here 'index_variable_selection' is the selected traffic variables
save('index_variable_selection.mat', 'index_variable_selection');
...
sigma_lag = sigma_processed.sigma_lag; % temporal
plot(sigma_lag) % ps: thelargest lag refers the closest time step
sigma_attr = sigma_processed.sigma_attr;% factor
sigma_station = sigma_processed.sigma_station; % spatial
